...
The `CoroutineScopeOwner` context is resolved automatically by the compiler — no explicit receiver is needed. See [UseCase](usecase.md) and [FlowUseCase](flow-usecase.md) for full details.
